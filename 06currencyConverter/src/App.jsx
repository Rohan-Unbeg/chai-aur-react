...
function App() {
    ...
    const convert = () => {
        ...
        console.log("Rate found:", currencyInfo[to]);
    };

    const BackgroundImage = `https://images.pexels.com/photos/1054218/pexels-photo-1054218.jpeg?auto=compress&cs=tinysrgb&w=600`;
    return (
        <div
